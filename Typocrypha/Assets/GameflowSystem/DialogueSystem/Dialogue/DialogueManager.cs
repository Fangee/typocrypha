...
public class DialogueManager : MonoBehaviour
{
    ...
    bool nextLine()
    {
        ...
        DialogueItem lineData = new DialogueItem(curr_dialogue.characterName, curr_dialogue.text);
        if (curr_dialogue is TypocryphaGameflow.DialogNodeVN)
        {
            //Sprite mc_sprite = ((DialogueItemVN)curr_dialogue).mc_sprite;
            //Sprite codec_sprite = ((DialogueItemVN)curr_dialogue).codec_sprite;
            //if (mc_sprite != null)
            ...
            d_box = VNDialogueBox;
            VNSpeaker.text = DialogueParser.main.substituteMacros(lineData.speaker_name);
        }
        ...
        Coroutine d_box_init = d_box.dialogueBoxStart(curr_dialogue);
        //Prompt input if necessary
        if (curr_dialogue is TypocryphaGameflow.DialogNodeInput)
        {
            input = true;
            StartCoroutine(showInput(lineData, d_box, d_box_init));
        }
        else
        {
            input = false;
    ...
    public void submitInput()
    {
        ...
        //        }
        //    }
        //    if (i < d_item.input_options.Length)
        //    { // Option was found, so branch
        ...
        //            }
        //        }
        //        if (i < d_item.input_answers.Length)
        //        { // Option was found, so branch
        //            AudioPlayer.main.playSFX("sfx_enter");
        //            GameflowManager.main.jump(d_item.input_branches[i].gameObject);
        //        }
